...
- Applying [converter tool](https://github.com/heartexlabs/datalabs-annotator-converter) to `my_project_name/completions` directory
...
```json
{
    ...
    "data": {
        "image": "https://htx-misc.s3.amazonaws.com/opensource/datalabs-annotator/examples/images/nick-owuor-astro-nic-visuals-wDifg5xc9Z4-unsplash.jpg"
    },
    "id": 1,
    "predictions": [
        {
